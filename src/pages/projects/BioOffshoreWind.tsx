...
import t2 from "@assets/wind/turbine-2.jpg";
import t3 from "@assets/wind/turbine-3.jpeg";

function BioOffshoreWind() {
  return (
    <>
      <Center>
        <H1>Offshore wind: A sustainable approach to green power</H1>
      </Center>
      <img src={t2} className="object-cover w-full max-h-80 mt-3 rounded-md" />
      <Separation />
      ...
      <img src={t3} className="object-cover w-full max-h-80 mt-3 rounded-md" />
      <H3>Citations</H3>
      <P>
...
export default BioOffshoreWind;
